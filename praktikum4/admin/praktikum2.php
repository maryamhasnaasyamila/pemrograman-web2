...
<div class="container" style="margin-top: 2vw;">
    <h2 style="margin-top: 2vw;">Form Input Nilai Mahasiswa</h2>
    <form action="../../praktikum2/form_hasil.php" method="GET" style="margin: 2vw;">
        <div class="form-group row">
          <label for="name" class="col-4 col-form-label">Nama</label> 
          <div class="col-8">
              <input id="name" name="name" placeholder="Masukkan Nama" type="text" required="required" class="form-control">
          </div>
        </div>
        <div class="form-group row">
