    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <!-- form validasi -->
                <form class="forms-sample" action="{{ url('/dashboard/anggota/update', $members->id) }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="Nama Anggota" value="{{ $members->name }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="email" class="form-control" id="email" name="email"
                                placeholder="Email" value="{{ $members->email }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input name="gender" id="gender_0" type="radio" class="custom-control-input"
                                    value="Pria" {{ $members->gender == 'Pria' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input name="gender" id="gender_1" type="radio" class="custom-control-input"
                                    value="Wanita" {{ $members->gender == 'Wanita' ? 'checked' : '' }}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="status" name="status"
                                placeholder="Status" value="{{ $members->status }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="address" name="address"
                                placeholder="Address" value="{{ $members->address }}">
                        </div>
                    </div>
